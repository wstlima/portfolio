<template>
  <div>
    <v-navigation-drawer v-model="drawer" absolute temporary app width="150" height="230">
      <v-list class="pt-4">
        ...
        <v-list-tile active-class="green--text" to="/curriculo">
          <v-list-tile-content>
    ...
    <v-toolbar flat dense color="transparent" scroll-off-screen>
      ...
      <v-toolbar-title class="headline">
        <span class="font-weight-light">Well </span>
        <span class="green--text">Full-Stack</span>
      </v-toolbar-title>
      <v-spacer></v-spacer>
      ...
      <v-toolbar-items class="hidden-sm-and-down">
        ...
        <v-btn flat to="/curriculo" active-class="green--text headline">Currículo</v-btn>
        <!-- <v-btn flat to="/services" active-class="green--text headline">Services</v-btn> -->
        <v-btn flat to="/portfolio" active-class="green--text headline">Portfólio</v-btn>
